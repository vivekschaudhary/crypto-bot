...
|---|---|---|---|---|---|
| [CB-1](bets/CB-1/brief.md) | 4 stories shipped (CB-1.1 + CB-1.1.1 + CB-1.2 + CB-1.3); CB-1.4 (proxy session validation) next | PM → Engineer | `/create-story CB-1` for CB-1.4 | 2026-05-31 | 2026-06-14 (per plan.md, high confidence on CB-1) |
