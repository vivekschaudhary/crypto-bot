...
|---|---|---|---|---|---|
| [CB-1](bets/CB-1/brief.md) | 5 stories shipped (CB-1.1 + CB-1.1.1 + CB-1.2 + CB-1.3 + CB-1.4); [CB-1.5](bets/CB-1/stories/CB-1.5/story.md) drafted (`status: ready`) — sign-out endpoint, awaiting `/build` | PM → Engineer | HITL approval of CB-1.5 story → `/build CB-1.5` | 2026-05-31 | 2026-06-21 (per plan v5; duration_weeks bumped 2 → 3 per adaptive-decomposition rule) |
...
- **[CB-1.5 story](bets/CB-1/stories/CB-1.5/story.md)** — sign-out endpoint (`POST /api/auth/sign-out`). Drafted 2026-06-02 via `/create-story CB-1`; status: `ready`. Reviewer-of-record: operator (HITL milestone). Approve by running `/build CB-1.5`, or push back with edits.
